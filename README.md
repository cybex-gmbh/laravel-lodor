...
### Customizing the Route Middlewares
...
You can customize the middleware that is applied to the routes registered by _Lodor_ by adjusting the `route_middlewares` array in the [Configuration](#Configuration).
...
| route_middlewares              |                              | ['web', 'auth'] | Array of middlewares to be applied to _Lodor_ routes.                                                                                                                                                                                                                                                                                                                                     |
